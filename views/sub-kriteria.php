                          ...
                          <div class="modal-content">
                            ...
                            <form action="" method="post">
                              <div class="modal-body">
                                ...
                                <div class="mb-3">
                                  <label for="nilai_sub" class="form-label">Nilai Sub</label>
                                  <select name="nilai_sub" class="form-select" required>
                                    <option value="5" <?php if(isset($_POST['nilai_sub']) && $_POST['nilai_sub'] == "5") echo "selected"; ?>>Tinggi</option>
                                    <option value="2" <?php if(isset($_POST['nilai_sub']) && $_POST['nilai_sub'] == "2") echo "selected"; ?>>Sedang</option>
                                    <option value="0" <?php if(isset($_POST['nilai_sub']) && $_POST['nilai_sub'] == "0") echo "selected"; ?>>Rendah</option>
                                  </select>
                                </div>
                              </div>
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <form action="" method="post">
                                        ...
                                        <div class="modal-body">
                                          ...
                                          <div class="mb-3">
                                            <label for="nilai_sub" class="form-label">Nilai Sub <span class="nilaiSub<?= $row['id_sub_kriteria'] ?>"><?= $row['nilai_sub'] ?></span></label><br>
                                            <select name="nilai_sub" class="form-select" id="mySlider<?= $row['id_sub_kriteria'] ?>" required>
                                            <?php
                                              $id_nilai_keanggotaan = 3; // ID nilai_keanggotaan yang diinginkan
                                              $query_nilai = mysqli_query($conn, "SELECT * FROM nilai_keanggotaan WHERE id_keanggotaan = $id_nilai_keanggotaan");
                                              $row_nilai = mysqli_fetch_assoc($query_nilai);
                                              ?>
                                              <option value="<?= $row_nilai['batas_bawah'] ?>" <?php if ($row['nilai_sub'] == $row_nilai['batas_bawah']) { echo 'selected'; } ?>>Rendah</option>
                                              <option value="<?= $row_nilai['batas_tengah'] ?>" <?php if ($row['nilai_sub'] == $row_nilai['batas_tengah']) { echo 'selected'; } ?>>Sedang</option>
                                              <option value="<?= $row_nilai['batas_atas'] ?>" <?php if ($row['nilai_sub'] == $row_nilai['batas_atas']) { echo 'selected'; } ?>>Tinggi</option>
            ...
            <div class="table-container">
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  ...
                  <div>
                    <div class="btn-wrapper">
                      <a href="#" class="btn btn-primary text-white me-0" data-bs-toggle="modal" data-bs-target="#tambah-nilai"><i class="bi bi-plus-lg"></i> Tambah</a>

...
- hebrew, khmer, cambodian, lao, and cjk-decimal recognimed as values for "list-style-type" in numbered lists and page numbering.
...
- @page :first not recognimed unless @page {} has styles set
...
- JPG images not recognimed if not containing JFIF or Exif markers
...
- SVG images - multiple, or quoted fonts e.g. style="font-family:'lucida grande', verdana" not recognimed
...
- SVG images - fill:RGB(0,0,0) not recognimed when uppercase
...
- khmer, cambodian and lao recognimed as list-style-type for numbered lists
...
Bug fixes
---------
- SVG images - path including e.g. 1.234E-15 incorrectly parsed (not recogniming capital E)
